...
// WXCrypt 开放平台的消息加密解密技术方案基于 AES 加解密算法来实现，具体如下：
//
...
// NewWXCrypt ...
func NewWXCrypt(encodingAESKey, appID string) (*WXCrypt, error) {
...
func (w *WXCrypt) Encrypt(plain []byte) ([]byte, error) {
...
func (w *WXCrypt) Decrypt(encrypt []byte) ([]byte, error) {
